...
namespace CommodityInfoManagement
{
    public abstract class MySQLHelper
    {
        ...
        public static readonly string connectionStringManager = ConfigurationManager.ConnectionStrings["MySQLConnStr"].ConnectionString;

        //The hashtable to store the parameter information, the hash table can store any type of argument 
        ...
        /// <summary>
        /// execute a trascation include one or more sql sentence
        /// </summary>
